...
$(document).ready(function(){
  $('#debug').click(function(){
    alert('Something will go here later')
  });
});
  ...
  $('#bAlpha').click(function(){
    switch (pageNum) {
      ...
      case 9:
        ...
        $('#para2').fadeOut(500, function(){$(this).html(para2_10); kinerine();}).fadeIn(1000);
        ...
        $('#bGamma').children('.bText').fadeOut(1).html('<br>Wait, why is that cow here?').fadeIn(2000); // ?
        break;
      case 10:
        if (wounded == false) {
          serumData = 1;
          ...
          $('#para2').fadeOut(500, function(){$(this).html(para2_11); harpoon(); signLang(); newBrooklyn();}).fadeIn(1000);
...
const para1_9 = 'Sandy lays in a new heading, ten miles SSW she estimates. That\'s where the <span id=janus class=tip>JANUS signals</span> are coming from. The message repeats in a loop, the urgent robotic voice occasionally gurgles with static. It\'s mostly gibberish mixed with strongly worded calls for help.<br><br> \"I\'ve never even seen an <span id=admiralty class=tip>Admiralty</span> distress call before,\" says Sandy. \"I think a lot of this is encoded. You know those old movies where people venture into the dark and get picked off one by one? Aliens, demons, homicidal masked men.\" <br><br>The first mate arrives with some caffeinated hydro sludge she calls coffee. \"On duty,\" she says. \"What\'s all this?\"<br><br> Sandy beckons the two of you over. She\'s got a feed from one of the forward cameras. \"Look.\"';
